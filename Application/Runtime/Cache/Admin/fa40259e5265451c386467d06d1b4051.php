                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <tbody>
                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t1): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><?php echo ($t1["publish_year"]); ?></td>
                                    <td><?php echo ($t1["publisher"]); ?></td>
                                    <td><?php echo ($t1["isbn"]); ?></td>
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                            <a class="blue" href="<?php echo U('Admin/Book/detail_view',array('id'=>$t1['id']));?>">
                                                <i class="icon-zoom-in bigger-130"></i>
                                            </a>
                                            <a class="green" href="<?php echo U('Admin/Book/detail_view',array('id'=>$t1['id']));?>">
                                                <i class="icon-pencil bigger-130"></i>
                                            </a>
                                            <a class="red" href="<?php echo U('Admin/Book/delete_book',array('id'=>$t1['id']));?>">
